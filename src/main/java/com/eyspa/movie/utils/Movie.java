...
public class Movie
{
    ...
    public static ArrayList<Category> getCate(final String type) throws IOException {
        ...
        for (int i = 1; i < ca.length; ++i) {
            final String lcat = ca[i].substring(0, ca[i].indexOf("\" class="));
    ...
    public static ArrayList searchInfo(String kw) throws IOException {
        ...
        for (final Element s : es) {
            ...
            final String type = ss.substring(ss.indexOf("<span class=\"playtype\">") + 24,ss.indexOf("<span class=\"playtype\">") + 30 );//ss.indexOf("</span>")
